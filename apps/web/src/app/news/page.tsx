...
export default function NewsPage() {
  return (
    <>
      ...
      {/* NCL Featured Recruitment Alert — Diploma Level */}
      <section className="max-w-7xl mx-auto px-5 mt-10">
        <div className="relative overflow-hidden rounded-3xl border border-blue-200/60 bg-gradient-to-br from-blue-50 via-white to-indigo-50 shadow-lg shadow-blue-100/40 dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 dark:border-slate-700 dark:shadow-none">
          {/* Decorative corner accent */}
          <div className="absolute -top-16 -right-16 w-48 h-48 bg-blue-200/20 rounded-full blur-3xl" />
          <div className="absolute -bottom-20 -left-20 w-56 h-56 bg-indigo-200/15 rounded-full blur-3xl" />
          ...
          <div className="relative flex flex-col lg:flex-row">
            ...
            <div className="lg:w-72 shrink-0 relative overflow-hidden p-6 sm:p-8 flex flex-col items-center justify-center text-center lg:min-h-[420px]">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-b from-[#1a3a5c]/95 via-[#0d2d4d]/90 to-[#0a2040]/95" />
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                />
                <p className="text-white/90 font-extrabold text-xl tracking-wide">NCL</p>
                ...
                <div className="mt-6 w-full space-y-2">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/10">
                    ...
                    <p className="text-white font-extrabold text-lg">259 Posts</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/10">
                    ...
                    <p className="text-white font-bold text-sm">05 August 2026</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 p-6 sm:p-8 lg:p-10">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="text-2xl sm:text-3xl font-extrabold text-ink tracking-tight dark:text-white">NCL Recruitment 2026</h3>
                    <span className="hidden sm:inline-flex items-center gap-1.5 bg-blue-600 text-white text-[10px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wider shrink-0">
                      <span className="w-1.5 h-1.5 bg-white rounded-full animate-pulse" />
                      Live
                    </span>
                  </div>
                  <p className="text-sm text-muted dark:text-slate-400">Statutory Supervisory Staff — Mining Sirdar &amp; Surveyor (Mining)</p>
                  <p className="text-xs text-muted/60 mt-0.5 dark:text-slate-400">Advt. No. NCL/SING/HR/2026-27/246 · CBT Based Selection</p>
                </div>
                <span className="sm:hidden inline-flex items-center gap-1.5 bg-blue-600 text-white text-[10px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wider w-fit">
                  <span className="w-1.5 h-1.5 bg-white rounded-full animate-pulse" />
                  Live
                </span>
              </div>

              <div className="bg-blue-100/50 border border-blue-200/60 rounded-xl px-5 py-3.5 mb-6 dark:bg-blue-900/20 dark:border-blue-800/40">
              ...
              <div className="mb-6">
                <p className="text-[11px] font-bold text-muted/50 uppercase tracking-[0.15em] mb-3 dark:text-slate-400">259 Vacancies · 2 Posts</p>
                <div className="flex flex-wrap gap-2">
                  {[
                    { name: "Mining Sirdar T&S Gr. C (254)", color: "bg-blue-50 text-blue-700 border-blue-200/60 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800/40" },
                    { name: "Surveyor T&S Gr. B (5)", color: "bg-indigo-50 text-indigo-700 border-indigo-200/60 dark:bg-indigo-900/30 dark:text-indigo-300 dark:border-indigo-800/40" },
                  ].map((d) => (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="bg-white border border-slate-100 rounded-xl px-4 py-3 shadow-sm dark:bg-slate-800 dark:border-slate-700">
                    ...
                    <ul className="text-[11px] text-muted/70 dark:text-slate-400 space-y-0.5 list-disc pl-3.5">
                      <li>Matriculate + DGMS Sirdar Certificate</li>
                  ...
                  <div className="bg-white border border-slate-100 rounded-xl px-4 py-3 shadow-sm dark:bg-slate-800 dark:border-slate-700">
                    <p className="font-bold text-ink text-sm dark:text-white mb-1">Surveyor (Mining)</p>
                    <ul className="text-[11px] text-muted/70 dark:text-slate-400 space-y-0.5 list-disc pl-3.5">
                      <li>Matriculate + Surveyors&apos; Certificate (SCC)</li>
                      <li>Under Coal Mines Regulation 2017</li>
                    </ul>
                    <p className="text-[10px] text-muted/50 mt-1.5 dark:text-slate-500">OR Diploma in Mining/Survey + SCC</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
                <div className="bg-white border border-slate-100 rounded-xl px-4 py-3 shadow-sm dark:bg-slate-800 dark:border-slate-700">
                  <div className="flex items-center gap-2 mb-1">
                    <svg className="w-3.5 h-3.5 text-blue-600" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 11H9v-2h2v2zm0-3H9V6h2v4z" /></svg>
                    <span className="text-[10px] font-bold text-muted/50 uppercase tracking-wider dark:text-slate-400">Pay Scale</span>
                  </div>
                  <p className="font-extrabold text-ink text-sm dark:text-white">T&S Gr. B / C</p>
                ...
                <div className="bg-white border border-slate-100 rounded-xl px-4 py-3 shadow-sm dark:bg-slate-800 dark:border-slate-700">
                  ...
                  <p className="font-extrabold text-ink text-sm dark:text-white">05 August 2026</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="group inline-flex items-center justify-center gap-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold px-7 py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 hover:shadow-lg hover:shadow-blue-200/50 transition-all duration-200 text-sm"
                >
                  Apply Now
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center justify-center gap-2.5 text-blue-700 font-bold px-7 py-3 rounded-xl border-2 border-blue-200 hover:bg-blue-50 hover:border-blue-300 transition-all duration-200 text-sm dark:text-blue-400 dark:border-blue-700 dark:hover:bg-blue-900/20 dark:hover:border-blue-600"
                >
                  View Recruitment
                  <svg className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                </a>
